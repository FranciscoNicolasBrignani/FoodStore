...
export const PRODUCTS: IProduct[] = [
  {
    ...
    stock: 20,
    imagen: "/src/assets/img/pizza.jpg",
    disponible: true,
  ...
  },
  {
    ...
    stock: 15,
    imagen: "/src/assets/img/pizzanapolitana.jpg",
    disponible: true,
    categorias: [categorias[0]],
  },
  {
    ...
    stock: 10,
    imagen: "/src/assets/img/4quesos.jpg",
    disponible: true,
    categorias: [categorias[0]],
  },
  {
  ...
  },
  {
    ...
    stock: 25,
    imagen: "/src/assets/img/hambbq.jpg",
    disponible: true,
    categorias: [categorias[1]],
  },
  {
    ...
    stock: 0,
    imagen: "/src/assets/img/hamv.jpg",
    disponible: false,
    categorias: [categorias[1]],
  },
  {
    ...
    stock: 100,
    imagen: "/src/assets/img/coca500.jpg",
    disponible: true,
  ...
  },
  {
    ...
    stock: 40,
    imagen: "/src/assets/img/jugo.jpg",
    disponible: true,
    categorias: [categorias[2]],
  },
  {
    ...
    stock: 150,
    imagen: "/src/assets/img/agua.jpg",
    disponible: true,
    categorias: [categorias[2]],
  },
  {
    ...
    stock: 12,
    imagen: "/src/assets/img/rogel.jpg",
    disponible: true,
  ...
  },
  {
    ...
    stock: 30,
    imagen: "/src/assets/img/helado.jpg",
    disponible: true,
    categorias: [categorias[3]],
  },
  {
    ...
    stock: 0,
    imagen: "/src/assets/img/brownie.jpg",
    disponible: false,
    categorias: [categorias[3]],
  },
  {
    ...
    stock: 50,
    imagen: "/src/assets/img/emcarne.jpg",
    disponible: true,
  ...
  },
  {
    ...
    stock: 45,
    imagen: "/src/assets/img/empollo.jpg",
    disponible: true,
    categorias: [categorias[4]],
  },
  {
    ...
    stock: 60,
    imagen: "/src/assets/img/emjyq.jpg",
    disponible: true,
    categorias: [categorias[4]],
  },
  {
    ...
    stock: 20,
    imagen: "/src/assets/img/cesar.jpg",
    disponible: true,
  ...
  },
  {
    ...
    stock: 18,
    imagen: "/src/assets/img/caprese.jpg",
    disponible: true,
    categorias: [categorias[5]],
  },
  {
    ...
    stock: 10,
    imagen: "/src/assets/img/fuga.jpg",
    disponible: true,
    categorias: [categorias[0]],
  },
  {
    ...
    stock: 0,
    imagen: "/src/assets/img/hampollo.jpg",
    disponible: false,
    categorias: [categorias[1]],
  },
  {
    ...
    stock: 25,
    imagen: "/src/assets/img/mixta.jpg",
    disponible: true,
    categorias: [categorias[5]],
  },
]
...
export const itemsCart: ICartItem[] = JSON.parse(
  localStorage.getItem("cart") || "[]"
);

export const guardarCart = (): void => {
